    ...
    >
      ...
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12 relative z-20">
        ...
        >
          ...
          <div className="relative rounded-full w-72 h-72 md:w-80 md:h-80 lg:w-96 lg:h-96 overflow-hidden border-4 border-white/10">
            {/* Actual image */}
            <img
            ...
            {/* Inner glow overlay */}
            <div className="absolute inset-0 bg-gradient-radial from-transparent to-indigo-500/20"></div>
          </div>
        </div>
      </div>
    </section>
