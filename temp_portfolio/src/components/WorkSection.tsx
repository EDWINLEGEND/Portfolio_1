        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects[activeTab as keyof typeof projects].map((project, index) => (
            ...
            >
              ...
              <div className="p-6 relative z-10">
                ...
                <div className="flex flex-wrap gap-2 mt-3">
                  {project.tools.map((tool, i) => (
                    <span 
                      key={i} 
                      className={`jsx-90d154deddfc17ef ${
                        "px-3 py-1 bg-gray-800 text-gray-300 text-xs rounded-full inline-block hover:bg-primary hover:text-white transition-colors duration-300"
                      }`}
                      style={{
                ...
                >
                  <button 
                    className={`jsx-90d154deddfc17ef ${
                      "absolute inset-0 bg-primary text-white px-4 py-1 rounded-md text-sm transition-all duration-300 group-hover:translate-y-0 translate-y-full hover:bg-primary-dark"
                    }`}
                  >
                    View Project →
                  </button>
              ...
              {/* Glowing corners as decoration */}
              <div className="absolute top-0 left-0 w-10 h-10 bg-primary/30 rounded-br-full blur-lg 
                opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              <div className="absolute bottom-0 right-0 w-10 h-10 bg-primary/30 rounded-tl-full blur-lg 
                opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
            </div>
          ))}
        </div>
